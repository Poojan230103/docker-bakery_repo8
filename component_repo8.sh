...
function usage() {
  ...
  echo "component = one among  [test-component1_repo8
                                test-component2_repo8
                                test-component3_repo8]"
...
function check_component() {
  ...
  case ${COMPONENT_NAME} in
    test-component1_repo8)
    DOCKERFILE_PATH=./components_repo8/test-component1_repo8/Dockerfile
    ;;
    test-component2_repo8)
    DOCKERFILE_PATH=./components_repo8/test-component2_repo8/Dockerfile
    ;;
    test-component3_repo8)
    DOCKERFILE_PATH=./components_repo8/test-component3_repo8/Dockerfile
    ;;
    *)
